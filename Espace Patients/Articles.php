            ...
            <div class="container-fluid py-5 bgArticle" style="margin-bottom: 90px;">
                <div class="row py-5">
                    <div class="col-12 pt-lg-5 mt-lg-5 text-center">
                        ...
                        <a href="Articles.php?userID=<?php echo $patientInfo['userID'] ?>" class="h5 text-white">Articles</a>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="col-lg-12">
                        <div class="row g-5">
                            ...
                            if ($current_page > 1) {
                                ...
                                echo '<a class="page-link rounded-0" style="color: #66CDAA;" href="Articles.php?userID=' . $patientInfo['userID'] . '&page=' . ($current_page - 1) . '" aria-label="Previous">';
                            ...
                            for ($i = 1; $i <= $total_pages; $i++) {
                                if ($i == $current_page) {
                                    echo '<li class="page-item active"><a class="page-link" style="color: black; background-color: #66CDAA; border:#66CDAA;" href="Articles.php?userID=' . $patientInfo['userID'] . '&page=' . $i . '">' . $i . '</a></li>';
                                } else {
                                    echo '<li class="page-item"><a class="page-link" style="color: black;" href="Articles.php?userID=' . $patientInfo['userID'] . '&page=' . $i . '">' . $i . '</a></li>';
                                }
                            }
                            ...
                            if ($current_page < $total_pages) {
                                echo '<li class="page-item">';
                                echo '<a class="page-link rounded-0" style="color: #66CDAA;" href="Articles.php?userID=' . $patientInfo['userID'] . '&page=' . ($current_page + 1) . '" aria-label="Next">';
