		...
		<div class="main-wrapper">
			...
			<div class="header">
				...
				<div class="top-nav-search">
					<form method="POST">
						<input type="text" name="recherche" class="form-control" placeholder="Recherche patients" autocomplete="off">
			...
			<div class="page-wrapper">
				<div class="content container-fluid">
					...
					if (isset($_POST['recherche']) && !empty(trim($_POST['recherche']))) {
						...
						$searchQuery = 'SELECT * FROM compte_utilisateurs u JOIN rendez_vous r ON u.userID = r.IDPatient LEFT JOIN paiements p ON p.IDRendez_vous = r.IDRdv WHERE u.Role = 0 ';
						$searchParams = array();
						...
						$recupPatient = $bdd->prepare('SELECT * FROM compte_utilisateurs u 
						JOIN rendez_vous r ON u.userID = r.IDPatient 
						LEFT JOIN paiements p ON p.IDRendez_vous = r.IDRdv
						WHERE u.Role = 0 AND r.Type = "En_ligne"
						ORDER BY r.IDPatient desc');
									...
									<tr>
										<td>
											<div class="d-flex align-items-center">
												<img src="../Espace Patients/img/<?php echo $infoPatient['PhotoProfile'] ?>" alt="" style="width: 45px; height: 45px" class="rounded-circle" />
												<div class="ms-3">
										...
										<td><?php echo $infoPatient['Statut'] ?></td>
										<?php if ($infoPatient['paye'] == "") { ?>
										...
										<?php } ?>
										<td><?php echo $infoPatient['Montant'] . ' TND '  ?></td>
										<td><?php echo $infoPatient['Date'] ?></td>
									</tr>
							<?php }
							} else{
